    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 border-t border-white/10">
        ...
        <div className="font-teko -mt-4 sm:-mt-8 lg:-mt-10 space-y-4 sm:space-y-6">
          ...
          <ul className="mt-6 space-y-3 sm:space-y-4 text-white/90 text-[0.95rem] leading-6">
            <li className="flex items-start gap-3">
              <IoMapSharp className="h-6 w-6 text-[#00acec]" aria-hidden="true" />
              <a
            ...
            <li className="flex items-center gap-3">
              <FaPhone className="h-5 w-5 text-[#00acec]" aria-hidden="true" />
              <a
            ...
            <li className="flex items-center gap-3">
              <IoMailOpen className="h-6 w-6 text-[#00acec]" aria-hidden="true" />
              <a
        ...
        <div className="font-teko -mt-4 sm:-mt-8 lg:-mt-10 space-y-4 sm:space-y-6">
          ...
          <div className="mx-auto w-full max-w-[520px] mt-6">
            <iframe
              className="block w-full h-[180px] rounded-lg border border-white/10"
